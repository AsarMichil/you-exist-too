<script lang="ts">
	...
	function onProfileModal(node: HTMLCanvasElement) {
...
{#if toggled}
	<div
		class="absolute w-screen h-screen bg-black bg-opacity-50 right-0 flex flex-row justify-center items-center dark:text-white"
	>
		<!-- Modal -->
